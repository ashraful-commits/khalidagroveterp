...
export function WelcomeCard() {
  ...
  return (
    <div className="relative bg-text-primary rounded-[2.5rem] p-10 overflow-hidden group min-h-[280px] flex flex-col justify-center">
      {/* Background Orbs */}
      ...
      <div className="relative z-10">
        ...
        <h1 className="text-4xl md:text-5xl font-syne font-black text-white leading-tight">
          Welcome back,<br />
        ...
        <div className="flex gap-4 mt-8">
          <button className="bg-primary text-white px-8 py-3.5 rounded-2xl font-bold text-sm shadow-2xl shadow-primary/40 hover:scale-105 active:scale-95 transition-all flex items-center gap-2">
