...
export function Sidebar() {
  ...
  const menuItems = [
    ...
    { label: t('inventory'), icon: Package, href: '/inventory', subItems: [
      ...
      { title: 'Inventory Request', href: '/inventory/request' },
      { title: 'Gate In / Out', href: '/inventory/gate' },
      { title: 'Stock Audit', href: '/inventory/audit' },
      { title: 'Adjustments', href: '/inventory/adjustment' },
      { title: 'Item Sources', href: '/inventory/source' },
    ]},
    { label: t('accounting'), icon: Calculator, href: '/accounting', subItems: [
      ...
      { title: 'Budget Control', href: '/accounting/budget' },
      { title: 'Cost Centers', href: '/accounting/center-setup' },
      { title: 'Project Accounting', href: '/accounting/project' },
      { title: 'Financial Reports', href: '/accounting/financial-report' },
      { title: 'Fund Transfer', href: '/accounting/transfer' },
    ]},
    { label: t('hr'), icon: Users, href: '/hr', subItems: [
      ...
      { title: 'HR Policies', href: '/hr/policies' },
      { title: 'Increments', href: '/hr/increment' },
      { title: 'Bonus Management', href: '/hr/bonus' },
      { title: 'Documentation', href: '/hr/documents' },
    ]},
    ...
    { label: t('crm'), icon: MessageSquare, href: '/crm', subItems: [
      { title: 'Management', href: '/crm/management' },
